...
class MoRFeusQt(QMainWindow, mrfui.Ui_mRFsMain):
    ...
    def linearSweepQt(self):
        # self.curQt()
        self.moRFeus.linear_sweep_bidirectional(self.startFreq.value(), self.endFreq.value(), self.stepSize.value(), self.delay.value())

    def quadraticSweepQt(self):
        # self.curQt()
        self.moRFeus.quadratic_sweep_bidirectional(self.startFreq.value(), self.endFreq.value(), self.stepSize.value(), self.delay.value())
