...
class Ui_mRFsMain(object):
    def setupUi(self, mRFsMain):
        ...
        # Button for linear sweep
        self.linearSweepButton = QtWidgets.QPushButton(self.centralwidget)
        self.linearSweepButton.setGeometry(QtCore.QRect(310, 200, 75, 23))
        self.linearSweepButton.setMaximumSize(QtCore.QSize(80, 25))
        self.linearSweepButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.linearSweepButton.setObjectName("linearSweepButton")
        self.linearSweepButton.setText("Linear Sweep")  # Set button text
        self.linearSweepButton.setToolTip("Perform a linear frequency sweep")
        
        # Button for quadratic sweep
        self.quadraticSweepButton = QtWidgets.QPushButton(self.centralwidget)
        self.quadraticSweepButton.setGeometry(QtCore.QRect(310, 230, 75, 23))
        self.quadraticSweepButton.setMaximumSize(QtCore.QSize(80, 25))
        self.quadraticSweepButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.quadraticSweepButton.setObjectName("quadraticSweepButton")
        self.quadraticSweepButton.setText("Quadratic Sweep")  # Set button text
        self.quadraticSweepButton.setToolTip("Perform a quadratic frequency sweep")
